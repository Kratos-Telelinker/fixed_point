...
REM
REM Generated by Vivado on Fri Sep 18 12:09:40 -0600 2026
...
echo "xvlog --incr --relax -L uvm -prj tb_fixed_point_top_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_fixed_point_top_vlog.prj -log xvlog.log
